	...
	serviceTimeoutSchemaAttribute = schema.SingleNestedAttribute{
		...
		Attributes: map[string]schema.Attribute{
			"list_services": schema.StringAttribute{
				MarkdownDescription: `List services operation timeout configuration`,
				Description:         `List services operation timeout configuration`,
				Optional:            true,
			},
			"is_enabled": schema.StringAttribute{
				MarkdownDescription: `Is enabled service operation timeout configuration`,
				Description:         `Is enabled service operation timeout configuration`,
				Optional:            true,
			},
			"disable_service": schema.StringAttribute{
				MarkdownDescription: `Disable service operation timeout configuration`,
				Description:         `Disable service operation timeout configuration`,
				Optional:            true,
			},
			"enable_service": schema.StringAttribute{
				MarkdownDescription: `Enable service operation timeout configuration`,
				Description:         `Enable service operation timeout configuration`,
				Optional:            true,
			},
			"start_service": schema.StringAttribute{
				MarkdownDescription: `Start service operation timeout configuration`,
				Description:         `Start service operation timeout configuration`,
				Optional:            true,
			},
			"stop_sevice": schema.StringAttribute{
				MarkdownDescription: `Stop service operation timeout configuration`,
				Description:         `Stop service operation timeout configuration`,
				Optional:            true,
			},
			"restart_service": schema.StringAttribute{
				MarkdownDescription: `Restart service operation timeout configuration`,
				Description:         `Restart service operation timeout configuration`,
				Optional:            true,
			},
		},
	}
